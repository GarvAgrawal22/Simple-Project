...
b7=customtkinter.CTkButton(root,text='7',font=('arial',20,'bold'),width=60,bg_color='black',command=lambda :click('7'))
...
bminus=customtkinter.CTkButton(root,text='-',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2',fg_color='orange',command=lambda :click('-'))
...
bclear=customtkinter.CTkButton(root,text='C',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2', fg_color='red',command=clear)
bclear.grid(row=4,column=2)
bdivision=customtkinter.CTkButton(root,text='/',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2', fg_color='orange',command=lambda :click('/'))
bdivision.grid(row=4,column=3)

bequal=customtkinter.CTkButton(root,text='=',font=('arial',20,'bold'),width=280,bg_color='black',cursor='hand2',fg_color='green',command=answer)
